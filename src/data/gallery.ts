/*
 * ============================================================================
 * FEATURE INDEX - src/data/gallery.ts
 * ============================================================================
 *
 * TYPE DEFINITIONS (Lines 1-34)
 * └─ GalleryItem interface - Photo metadata structure
 *
 * GALLERY DATA (Lines 36-3959)
 * └─ galleryItems array - Auto-generated photo collection
 *    └─ Generated by: scripts/build-gallery.js
 *
 * CATEGORIES (Lines 3960-3968)
 * └─ categories array - Filter options for gallery
 *
 * NOTE: This file is auto-generated. Run `npm run build:gallery` to regenerate.
 *
 * ============================================================================
 */
...
export interface GalleryItem {
  ...
  additionalCategories?: string[]; // Array of additional categories this photo can appear in
